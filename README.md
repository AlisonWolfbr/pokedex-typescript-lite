...
| Menu interativo | Revisar README |  | Interfaces |
| Persistência futura |  |  | PokeAPI |
| Filtros por tipo |  |  | Catálogo |
|  |  |  | Tratamento de erros |
...
- `npm install` � instala��o das depend�ncias.
- `npm run start` � execu��o da aplica��o em TypeScript.
- `npm run build` � compila��o do TypeScript.
- `npm run start:compiled` � execu��o da vers�o compilada.

Os testes demonstram o consumo da PokeAPI, inclus�o de Pok�mon no cat�logo, preven��o de duplicidade, tratamento de Pok�mon inexistente, listagem e remo��o por ID.
